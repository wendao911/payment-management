...
CREATE TABLE `attachments`  (
  ...
  `RelatedTable` enum('PayableManagement','PaymentRecords','Contracts','Temp') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '关联表名',
  `RelatedId` int COMMENT '关联记录ID',
