...
CREATE TABLE `attachments`  (
  ...
  `RelatedTable` enum('PayableManagement','PaymentRecords','Contracts','Temp') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '关联表名',
  `RelatedId` int NOT NULL COMMENT '关联记录ID',
...
CREATE TABLE `contracts`  (
  ...
  CONSTRAINT `contracts_ibfk_1` FOREIGN KEY (`ParentContractId`) REFERENCES `contracts` (`Id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `contracts_ibfk_2` FOREIGN KEY (`SupplierId`) REFERENCES `suppliers` (`Id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '合同信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '供应商信息表' ROW_FORMAT = Dynamic;
